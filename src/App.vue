<template>
  <div id="app" class="min-h-screen bg-gray-200 antialiased">
    <header class="flex justify-betweenitems-center bg-gray-900 px-4 py-3">
      <div>
        <svg
          class="h-8 w-auto"
          viewBox="0 0 185 32"
    ...
    <section class="flex justify-between bg-gray-800 px-4 py-3">
      ...
      <button
        class="inline-flex bg-gray-700 hove:bg-gray-600 focus:outline-none focus:shadow-outline rounded-lg shadow pl-3 pr-4"
      >
        <svg
          class="h-6 w-6 fill-current text-gray-500"
          viewBox="0 0 24 24"
        ...
        <div>
          ...
          <div class="relative px-4 -mt-16">
            <div class="bg-white rounded-lg px-4 py-4 shadow-lg">
              <div class="flex">
                <span
                  class="inline-block px-2 py-1 leading-none bg-teal-200 text-teal-900 rounded-full font-semibold uppercase tracking-wide text-xs"
                >
                Plus
                </span>
                <div class="ml-2 text-xs text-gray-600 font-semibold uppercase tracking-wider">
                  3 beds &bull; 2 baths
                </div>
              </div>
            
            <h4 class="mt-1 text-gray-900 font-semibold text-lg">             
              Modern Home incity center
            </h4>
            <div class="mt-1">
            ...
            <div class="mt-2 flex items-center text-sm text-gray-600">
              <svg v-for="index in 5" :key="index" class="h-4 w-4 fill-current text-teal-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
