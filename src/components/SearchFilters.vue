  ...
  <section class="bg-gray-800 xl:w-72">
    <div class="flex justify-between px-4 py-3 xl:hidden">
      <div class="relative max-w-xs w-full">
        ...
        <input
          class="block w-full bg-gray-900 text-white focus:outline-none focus:bg-white focus:text-gray-900 rounded-lg pl-10 pr-4 py-2"
          type="text"
      ...
      <button
        type="button"
        class="ml-4 inline-flex focus:outline-none focus:shadow-outline rounded-lg pl-3 pr-4"
        @click="toggle"
        :class="{'bg-gray-600 hover:bg-gray-500':isOpen, 'bg-gray-700 hover:text-gray-800 shadow':!isOpen}"
      >
        <svg
          class="h-6 w-6 fill-current"
          :class="{'text-gray-800':isOpen, 'text-gray-600':!isOpen}"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
        ...
        <span class="text-white ml-1 font-medium" :class="{'text-gray-800':isOpen, '':!isOpen}">filters</span>
      </button>
    </div>
    <form :class="{'hidden': !isOpen, 'block': isOpen}" class="xl:h-full xl:flex xl:flex-col xl:justify-between">
        ...
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 xl:border-t-0 xl:w-full">
          <div class="flex flex-wrap -mx-2">
            ...
            <label class="mt-4 block w-full px-2 sm:mt-0 sm:w-1/2 lg:mt-4 lg:w-full">
              ...
              <select class="mt-1 form-select block w-full">
                <option value>Up to $3.000/wk</option>
              </select>
            </label>
          </div>
        </div>
        ...
        <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
          ...
          <div class="sm:flex sm:-mx-2 sm:flex-wrap">
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox" type="checkbox" name="amenities" value="house" />
            ...
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox" type="checkbox" name="amenities" value="pool" checked />
              <span class="ml-2 text-white">Pool</span>
            </label>
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox" type="checkbox" name="amenities" value="beach" />
              <span class="ml-2 text-white">Beach</span>
            </label>
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox" type="checkbox" name="amenities" value="pet-friendly" />
              <span class="ml-2 text-white">PetFriendly</span>
            </label>
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox" type="checkbox" name="amenities" value="kid-friendly" />
              <span class="ml-2 text-white">Kid Friendly</span>
            </label>
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox" type="checkbox" name="amenities" value="parking" />
      ...
      <div class="bg-gray-900 px-4 py-4 sm:text-right">
        <button
          class="block w-full sm:w-auto sm:inline-block bg-blue-500 hover:bg-indigo-400 font-semibold text-white px-4 py-2 rounded-lg xl:block xl:w-full"
