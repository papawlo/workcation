        ...
        <div class="px-5 py-5">
         ...
         <div class="mt-5">
            <a href="http://" class="block text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer"
              >Account settings</a
            >
            <a href="http://" class="mt-3 block text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer">Suport</a>
            <a href="http://" class="mt-3 block text-gray-400 hover:text-white" target="_blank" rel="noopener noreferrer"
              >Sign out</a
            >
         </div>
        </div>
